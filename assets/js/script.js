...
function drawForcast (response) {
    ...
    $("#oneDayAhead img").attr("src", "http://openweathermap.org/img/w/"+response.daily[1].weather[0].icon+".png");
    ...
    $("#twoDaysAhead img").attr("src", "http://openweathermap.org/img/w/"+response.daily[2].weather[0].icon+".png");
    ...
    $("#threeDaysAhead img").attr("src", "http://openweathermap.org/img/w/"+response.daily[3].weather[0].icon+".png");
    ...
    $("#fourDaysAhead img").attr("src", "http://openweathermap.org/img/w/"+response.daily[4].weather[0].icon+".png");
    ...
    $("#fiveDaysAhead img").attr("src", "http://openweathermap.org/img/w/"+response.daily[5].weather[0].icon+".png");
